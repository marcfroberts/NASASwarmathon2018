...
class RxmSVSI_SV {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('azi')) {
        this.azi = initObj.azi
      }
      else {
        this.azi = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int16(obj.azi, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.azi = _deserializer.int16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.azi !== undefined) {
      resolved.azi = msg.azi;
    }
    else {
      resolved.azi = 0
    }
